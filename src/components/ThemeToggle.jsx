  ...
  return (
    <div className="fixed top-6 right-6 z-50">
      ...
      >
        ...
        {/* Frutiger Aero gradient when in light mode */}
        <motion.div
          className="absolute inset-0 rounded-full"
          initial={false}
          animate={{ 
            opacity: theme === "light" ? 1 : 0,
            background: 'linear-gradient(135deg, rgba(0,180,255,0.3) 0%, rgba(0,255,180,0.3) 50%, rgba(255,255,255,0.3) 100%)'
          }}
          transition={{ duration: 0.3 }}
        />
        
        {/* Neo gradient when in dark mode */}
        <motion.div
